...
namespace ResoucesWebApi.Controllers
{
    [ApiController]
    public class WeatherForecastController : ControllerBase
    {
        ...
        public IEnumerable<WeatherForecast> GetAdminData()
        {
            return Enumerable.Range(1, 5).Select(index => new WeatherForecast
            {
                Date = DateTime.Now.AddDays(index),
        ...
        public IEnumerable<WeatherForecast> GetAccountantData()
        {
            return Enumerable.Range(1, 5).Select(index => new WeatherForecast
            {
                Date = DateTime.Now.AddDays(index),
        ...
        public IEnumerable<WeatherForecast> GetSellerData()
        {
            return Enumerable.Range(1, 5).Select(index => new WeatherForecast
            {
                Date = DateTime.Now.AddDays(index),
