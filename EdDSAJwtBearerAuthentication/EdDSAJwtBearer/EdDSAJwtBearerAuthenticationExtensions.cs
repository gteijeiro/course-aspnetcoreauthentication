...
namespace EdDSAJwtBearer
{
    public static class EdDSAJwtBearerAuthenticationExtensions
    {
            ...
            Action<EdDSAJwtBearerOptions> configureOptions)
        {
            ...
            builder.Services.AddAuthentication().AddScheme<EdDSAJwtBearerOptions, EdDSAJwtBearerAuthenticationHandler>(authenticationScheme, configureOptions);
        ...
        {
            return AddEdDSAJwtBearer(builder, EdDSAJwtBearerDefaults.AuthentiactionScheme, configureOptions);
        }
        ...
        {
            return AddEdDSAJwtBearer(builder, EdDSAJwtBearerDefaults.AuthentiactionScheme, _ => { });
        }
